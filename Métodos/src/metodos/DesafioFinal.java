	...
	public static void main(String[] args) {
		...
		while (resultado == false && nroJogada != 9) {
			...
			do {
				...
				validar = colocar(jogada, montarEstrutura, jogador); //Retornando a validação de jogada

			} while (validar == true); //validar = falso sai do 'do'
			resultado = validarVitoria(montarEstrutura, jogador); //Retornando se alguem venceu ou não
